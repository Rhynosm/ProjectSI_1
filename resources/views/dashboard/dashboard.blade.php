...
<body>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Ijin <span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Gaji <span>| This Month</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>RP. 10,000,000</h6>
                      <span class="text-success small pt-1 fw-bold">5%</span> <span class="text-muted small pt-2 ps-1">Naik</span>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Pengguna <span></span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>Octaryo Lucas Martua Simamora</h6>
                      <span class="text-danger small pt-1 fw-bold">HRD</span> <span class="text-muted small pt-2 ps-1"></span>
              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#">Perguruan Tinggi</a></li>
                  </ul>
                </div>

                <div class="card-body pb-0">
                  <h5 class="card-title">Pendidikan <span>| Perguruan Tinggi</span></h5>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a href="#" class="text-primary fw-bold">ITN Malang</a></td>
                        <td>2025</td>
                        <td class="fw-bold">3.5</td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/product-1.jpg" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Harvard University</a></td>
                        <td>2025</td>
                        <td class="fw-bold">3.65</td>
                      </tr>
                    </tbody>
                  </table>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>PT. BANK MANDIRI</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
