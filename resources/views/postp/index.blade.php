          ...
          <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="card border-0 shadow-sm rounded">
                      <div class="card-body">
                          <a href="{{ route('postp.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                          <a href='{{ url('postp/view/pdf') }}' class="btn btn-danger fa fa-download ml-5">Download PDF</a>
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                @forelse ($postp as $postc)
                                  <tr>
                                      <td>{{ $postc->password }}</td> 
                                      <td>{{ $postc->username }}</td>
                                      <td class="text-center">
                                          <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('postp.destroy', $postc->id) }}" method="POST">
                                              <a href="{{ route('postp.show', $postc->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                              <a href="{{ route('postp.edit', $postc->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                              @csrf
                                              @method('DELETE')
