      ...
      <div class="row">
        ...
        <div class="container mt-5">
          <div class="row">
              <div class="col-md-12">
                  <div>
                      <h3 class="text-center my-4">DATA PENGEMBANGAN PEGAWAI</h3>    
                      <hr>
                  </div>
                  <div class="card border-0 shadow-sm rounded">
                      <div class="card-body">
                          <a href="{{ route('postn.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                          <a href='{{ url('postn/view/pdf') }}' class="btn btn-danger fa fa-download ml-5">Download PDF</a>
                          <table class="table table-bordered">
                              <thead>
                                <tr>
                                  <th scope="col">NAMA PELATIHAM</th>
                              ...
                              <tbody>
                                @forelse ($postn as $postm)
                                  <tr>
                                      <td>{{ $postm->namapel }}</td> 
                                      <td>{{ $postm->penyelenggara }}</td>
                                      <td>{{ $postm->tanggalmulai }}</td>
                                      <td>{{ $postm->tanggalberakhir }}</td>
                                      <td>{{ $postm->biaya }}</td>
                                      <td class="text-center">
                                          <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('postn.destroy', $postm->id) }}" method="POST">
                                              <a href="{{ route('postn.show', $postm->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                              <a href="{{ route('postn.edit', $postm->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                              @csrf
                                              @method('DELETE')
