      ...
      <div class="row">
        ...
        <div class="container mt-5">
          <div class="row">
              <div class="col-md-12">
                  <div>
                      <h3 class="text-center my-4">DATA ABSENSI PEGAWAI</h3>    
                      <hr>
                  </div>
                  <div class="card border-0 shadow-sm rounded">
                      <div class="card-body">
                          <a href="{{ route('posta.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                          <a href='{{ url('posta/view/pdf') }}' class="btn btn-danger fa fa-download ml-5">Download PDF</a>
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                @forelse ($posta as $postb)
                                  <tr>
                                      <td>{{ $postb->tglhadir }}</td> 
                                      <td>{{ $postb->waktuhadir }}</td>
                                      <td class="text-center">
                                          <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('posta.destroy', $postb->id) }}" method="POST">
                                              <a href="{{ route('posta.show', $postb->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                              <a href="{{ route('posta.edit', $postb->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                              @csrf
                                              @method('DELETE')
