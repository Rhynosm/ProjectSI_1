      ...
      <div class="row">
        ...
        <div class="container mt-5">
          <div class="row">
              <div class="col-md-12">
                  <div>
                      <h3 class="text-center my-4">DATA JENIS IJIN PEGAWAI</h3>    
                      <hr>
                  </div>
                  <div class="card border-0 shadow-sm rounded">
                      <div class="card-body">
                          <a href="{{ route('postj.create') }}" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
                          <a href='{{ url('postj/view/pdf') }}' class="btn btn-danger fa fa-download ml-5">Download PDF</a>
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                @forelse ($postj as $postC)
                                  <tr>
                                      <td>{{ $postC->jenis }}</td> 
                                      <td>{{ $postC->keterangan }}</td>
                                      <td class="text-center">
                                          <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('postj.destroy', $postC->id) }}" method="POST">
                                              <a href="{{ route('postj.show', $postC->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                              <a href="{{ route('postj.edit', $postC->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                              @csrf
                                              @method('DELETE')
